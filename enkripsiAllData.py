...
class Blowfish:
    ...
    def encrypt(self, plain_text):
        ...
        vignere_text_e = self.cipher_text(
            vignere_text, self.generate_key_cipher(vignere_text, self.key))
    ...
    def decrypt(self, encrypted_text):
        ...
        vignere_text_d = self.original_text(
            vignere_text, self.generate_key_cipher(vignere_text, self.key))

        decrypted_text += vignere_text_d

        bytes_ = bytes(int(decrypted_text[i:i + 2], 16)
